...
func (p *DynamlGrammar) Init() {
	...
	_rules = [...]func() bool{
		...
		func() bool {
			...
			l124:
				depth--
				add(ruleSimpleMerge, position122)
			}
			return true
		l121:
		...
		/* 32 Mapping <- <('m' 'a' 'p' '[' Expression '|' ws Name (ws ',' ws Name)? ws '|' ws ('-' '>') Expression ']')> */
		func() bool {
